...
PISO_LIFESTYLE_FRACTION  = _P.get("piso_lifestyle_fraction",  0.80)
MIN_QUALITY_FRAC         = _P.get("min_quality_frac",         0.85)
MIN_QUALITY_GOGOWINDOW   = _P.get("min_quality_gogowindow",   10)
