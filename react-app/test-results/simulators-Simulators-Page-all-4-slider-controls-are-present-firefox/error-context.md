...
- Name: simulators.spec.ts >> Simulators Page >> all 4 slider controls are present
- Location: e2e/simulators.spec.ts:17:7
...
Locator: locator('text=Market Stress Level')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Market Stress Level')
