...
- Name: simulators.spec.ts >> Simulators Page >> monthly contribution affects trajectories
- Location: e2e/simulators.spec.ts:146:7
...
Call log:
  - waiting for locator('input[type="range"]').nth(1)
