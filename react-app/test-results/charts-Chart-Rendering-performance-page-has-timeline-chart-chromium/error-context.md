...
- Name: charts.spec.ts >> Chart Rendering >> performance page has timeline chart
- Location: e2e/charts.spec.ts:29:7
...
Locator: locator('h3:has-text("Historical Performance")')
Expected: visible
Error: element(s) not found

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('h3:has-text("Historical Performance")')
...
```yaml
- generic [ref=e2]: Cannot GET /performance
```
