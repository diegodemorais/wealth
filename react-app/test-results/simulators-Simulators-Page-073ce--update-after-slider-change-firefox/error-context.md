...
- Name: simulators.spec.ts >> Simulators Page >> Monte Carlo trajectories update after slider change
- Location: e2e/simulators.spec.ts:100:7
...
Locator: locator('text=Monte Carlo Trajectories')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Monte Carlo Trajectories')
