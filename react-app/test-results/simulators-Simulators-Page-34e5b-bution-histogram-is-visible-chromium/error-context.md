...
- Name: simulators.spec.ts >> Simulators Page >> drawdown distribution histogram is visible
- Location: e2e/simulators.spec.ts:85:7
...
Locator: locator('text=Drawdown Distribution')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Drawdown Distribution')
