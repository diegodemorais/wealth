...
// ── B13: Renda+ 2065 vs IPCA+2050 — Análise de Duração ───────────────────────

function RendaVsIpcaDuracaoSection() {
  const data = useDashboardStore(s => s.data);
  const { privacyMode } = useUiStore();
  ...
  return (
    <CollapsibleSection
      ...
      title={secTitle('simuladores', 'renda-vs-ipca-duracao', 'Renda+ 2065 vs IPCA+2050 — Análise de Duração')}
      defaultOpen={secOpen('simuladores', 'renda-vs-ipca-duracao', false)}
    >
      {/* Intro */}
...
export default function SimulatorsPage() {
  ...
  return (
    <div>
      ...
      {/* 2b. B13: Renda+ 2065 vs IPCA+2050 — Análise de Duração */}
