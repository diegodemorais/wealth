      ...
      series: [
        {
          ...
          itemStyle: { borderWidth: 2, borderColor: EC.card },
            ...
            series: [
              {
                ...
                itemStyle: { color: EC.accent, borderColor: EC.card, borderWidth: 2 },
              ...
              // Annotate guardrail thresholds
              {
                ...
                symbolSize: 8,
                itemStyle: { color: EC.yellow, borderColor: EC.card, borderWidth: 2 },
              },
            ],
          };
