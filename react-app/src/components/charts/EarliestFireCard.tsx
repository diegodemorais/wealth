...
const styles: Record<string, React.CSSProperties> = {
  card: { backgroundColor: '#1f2937', border: '2px solid #10b981', borderRadius: '12px', padding: '24px', marginBottom: '14px', textAlign: 'center' },
  title: { margin: '0 0 16px 0', color: '#fff', fontSize: '18px' },
  date: { margin: '12px 0', color: '#10b981', fontSize: '28px', fontWeight: '700' },
  subtitle: { margin: '8px 0', color: '#9ca3af', fontSize: '14px' },
  masked: { fontSize: '28px', color: '#9ca3af' },
  badge: { marginTop: '16px', padding: '8px 12px', backgroundColor: '#10b981', borderRadius: '6px', display: 'inline-block' },
