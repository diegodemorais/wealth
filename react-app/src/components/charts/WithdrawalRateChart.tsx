      ...
      series: [
        {
          ...
          markPoint: {
            data: [
              { xAxis: '2049', yAxis: swrBruta[trilhaDatas.indexOf(2049)] ?? 0, name: 'INSS Katia', symbol: 'pin', symbolSize: 20, itemStyle: { color: EC.pink }, label: { formatter: 'INSS K', fontSize: 9 } },
        ...
        },
        {
          ...
          type: 'line',
          data: inssKatiaLine,
          lineStyle: { color: EC.pink, width: 1.5, type: 'dashed' },
          itemStyle: { color: EC.pink },
          symbol: 'none',
          connectNulls: false,
        },
        {
          ...
          type: 'line',
          data: inssDiegoLine,
          lineStyle: { color: EC.accent, width: 1.5, type: 'dashed' },
