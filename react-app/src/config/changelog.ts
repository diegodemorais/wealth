...
export const CHANGELOG: ChangelogEntry[] = [
  { datetime: '2026-05-01T08:00:00-03:00', type: 'gráfico', component: 'WithdrawalRateChart', tab: 'fire', anchor: 'section-withdrawal-rate', de: 'Apenas SWR bruta e líquida (pós-INSS agregado)', para: 'Adiciona 2 linhas de decomposição: INSS Katia (% do portfolio, a partir de 2049) e INSS Diego (a partir de 2052) — mostra contribuição individual de cada fluxo para redução do saque' },
  { datetime: '2026-05-01T07:00:00-03:00', type: 'gráfico', component: 'NetWorthProjectionChart', tab: 'fire', anchor: '', de: 'Pós-FIRE usava retornos blended analíticos (2.5%/3.5%/4.5% real) — aproximação sem spending smile real nem VCMH correto', para: 'Pós-FIRE agora usa trilha_p10/p50/p90 das 10k simulações MC (spending smile + VCMH + guardrails + bond pool + INSS). PostFireFanChart removido — funcionalidade unificada. Linha horizontal FIRE Number adicionada.' },
  { datetime: '2026-05-01T06:00:00-03:00', type: 'gráfico', component: 'WithdrawalRateChart', tab: 'fire', anchor: 'section-withdrawal-rate', de: 'SWR exibido apenas como número estático', para: 'FR-withdrawal-rate-chart: linha SWR bruta vs líquida (pós-INSS) 2038–2075 com gatilho 3% e marcadores INSS Katia (2049) e Diego (2052)' },
