...
| IOF | 1,1% (verificar periodicamente) | memoria 05-tributacao |
| Custo total one-time cambio | ~1,35% (~0,12%/ano diluido) | memoria 05-tributacao |
| IR ETFs exterior | 15% flat (Lei 14.754/2023) | memoria 05-tributacao |
