...
| 2026-04-06 | ~~P(FIRE) oficial: 90.4% / 94.1% / 86.8%~~ | Substituído por recalibração healthcare 2026-04-23 | Head, FIRE, Quant |
| 2026-04-23 | **P(FIRE) oficial**: 86.4% base / 92.0% favorável / 82.5% stress | MC 10k sims. SAUDE_BASE R$24k (era R$18k). VCMH 5.0% (era 2.7%). Pesquisa web: planos SP R$1.3-2k/mês, VCMH real 7-10%. FR-healthcare-recalibracao. | Head, FIRE, Quant, 4 modelos externos, pesquisa web SP |
