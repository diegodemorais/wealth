...
| **Status** | Backlog |
| **Prioridade** | Media |
| **Participantes** | 10 Advocate, 11 Oportunidades, 01 CIO, 05 Tributacao |
| **Dependencias** | — |
...
> Avaliar se ouro (2-3% via IGLN UCITS) agrega valor a carteira como tail risk hedge, especialmente contra risco fiscal BR. Debate estruturado Bull vs Bear obrigatorio.
