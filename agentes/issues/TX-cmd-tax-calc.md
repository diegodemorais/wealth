...
Command `.claude/commands/tax-calc.md` criado. Aceita: ticker, shares, preço venda, câmbio venda. Lê custo médio de `carteira.md` e lotes de `tlh_lotes.json`. Aplica Lei 14.754/2023 (15% flat, sem isenção R$35k). Output: breakdown completo + valor DARF código 6015.
