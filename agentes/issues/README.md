...
| DEV-now-refactor | Refactor NOW page.tsx — extrair sub-componentes (1053 → ~500) | Dev | 🟡 Média | — |
| DEV-factor-views-tab-toggle | Consolidar 3 factor views em PORTFOLIO via tab toggle | Dev | 🟢 Baixa | — |
| DEV-metriccard-tooltip-api | MetricCard — prop `title`/tooltip + popover primitive | Dev | 🟢 Baixa | — |
