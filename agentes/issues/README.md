...
### Done — Últimos Componentes Alterados (30+ linhas)
> Últimas mudanças em código, testes e configuração (2026-04-27 até 2026-04-22)

| ID | Componente | Data | Descrição | Link |
|----|-----------|------|-----------|------|
| XX-test-parameters-audit | Config: AVGS TER | 2026-04-27 | Corrigido 0.25% → 0.39% | [scripts/config.py#206](https://github.com/diegodemorais/wealth/blob/main/scripts/config.py#L206) |
| XX-test-parameters-audit | Config: AVEM TER | 2026-04-27 | Corrigido 0.25% → 0.35% | [scripts/config.py#207](https://github.com/diegodemorais/wealth/blob/main/scripts/config.py#L207) |
| XX-test-parameters-audit | Config: JPGL TER | 2026-04-27 | Corrigido 0.38% → 0.19% | [scripts/config.py#208](https://github.com/diegodemorais/wealth/blob/main/scripts/config.py#L208) |
| XX-test-parameters-audit | Test: P0 Schema Validation | 2026-04-27 | 8 novos testes (fixtures, validações P0) | [scripts/tests/test_audit_p0_p1.py#32-150](https://github.com/diegodemorais/wealth/blob/main/scripts/tests/test_audit_p0_p1.py#L32) |
| XX-test-parameters-audit | Test: P1 FIRE Logic | 2026-04-27 | 5 testes (stress, ordering, ranges, guardrails, SoRR) | [scripts/tests/test_audit_p0_p1.py#200-350](https://github.com/diegodemorais/wealth/blob/main/scripts/tests/test_audit_p0_p1.py#L200) |
| XX-test-parameters-audit | Test: P1 Tax Logic | 2026-04-27 | 5 testes (estate tax, DARF 6015, carryforward, PTAX, TaxSnapshot) | [scripts/tests/test_audit_p0_p1.py#350-420](https://github.com/diegodemorais/wealth/blob/main/scripts/tests/test_audit_p0_p1.py#L350) |
| XX-test-parameters-audit | Test: P1 Factor Logic | 2026-04-27 | 4 testes (FF5 magnitudes, SMB post-2010, HML, AUM threshold) | [scripts/tests/test_audit_p0_p1.py#420-480](https://github.com/diegodemorais/wealth/blob/main/scripts/tests/test_audit_p0_p1.py#L420) |
| XX-test-parameters-audit | Test: P1 RF Logic | 2026-04-27 | 5 testes (duration, MTM convexity, bond pool, IPCA+ spread) | [scripts/tests/test_audit_p0_p1.py#480-560](https://github.com/diegodemorais/wealth/blob/main/scripts/tests/test_audit_p0_p1.py#L480) |
| XX-test-parameters-audit | Test: P1 Advocate Logic | 2026-04-27 | 4 testes (patrimonio range, trilha triplet, schema, bond coverage) | [scripts/tests/test_audit_p0_p1.py#560-620](https://github.com/diegodemorais/wealth/blob/main/scripts/tests/test_audit_p0_p1.py#L560) |
| XX-test-parameters-audit | Test: React P0-P1 | 2026-04-27 | 40+ testes TypeScript (fixtures, schema, lógica pura) | [react-app/tests/audit-p0-p1.test.ts](https://github.com/diegodemorais/wealth/blob/main/react-app/tests/audit-p0-p1.test.ts) |
| XX-test-parameters-audit | Test: Canonicalization Cleanup | 2026-04-27 | Fundidos 2 testes (percentStr+scaling), removidos 2 triviais | [scripts/tests/test_pfire_canonicalization_audit.py#166-200](https://github.com/diegodemorais/wealth/blob/main/scripts/tests/test_pfire_canonicalization_audit.py#L166) |
| XX-test-parameters-audit | Test: Phase 4 Dashboard Cleanup | 2026-04-27 | Removidos 2 testes (assert True, data_is_serializable) | [scripts/tests/test_phase4_dashboard.py#156-173](https://github.com/diegodemorais/wealth/blob/main/scripts/tests/test_phase4_dashboard.py#L156) |
| XX-test-parameters-audit | Docs: Audit Master Issue | 2026-04-27 | Issue XX-test-parameters-audit criada (auditoria completa) | [agentes/issues/XX-test-parameters-audit.md](https://github.com/diegodemorais/wealth/blob/main/agentes/issues/XX-test-parameters-audit.md) |
| XX-test-parameters-audit | Docs: Post-Audit Gaps | 2026-04-27 | Mapa 28 gaps bloqueados por data.json (P0, P1, procedure) | [agentes/issues/XX-POST-AUDIT-GAPS.md](https://github.com/diegodemorais/wealth/blob/main/agentes/issues/XX-POST-AUDIT-GAPS.md) |
| VERIF-PFIRE-CANONICO | Python: fire_montecarlo.py | 2026-04-26 | 10 violations corrigidas (p_sucesso × 100 → canonicalize_pfire) | [scripts/fire_montecarlo.py#438-1194](https://github.com/diegodemorais/wealth/blob/main/scripts/fire_montecarlo.py#L438) |
| VERIF-PFIRE-CANONICO | React: assumptions/page.tsx | 2026-04-26 | 2 violations corrigidas (inline × 100 → .percentStr) | [react-app/src/app/assumptions/page.tsx#632-664](https://github.com/diegodemorais/wealth/blob/main/react-app/src/app/assumptions/page.tsx#L632) |
| VERIF-PFIRE-CANONICO | Python: pfire_transformer.py | 2026-04-26 | Adicionado alias percentStr para compatibilidade TypeScript | [scripts/pfire_transformer.py#33-35](https://github.com/diegodemorais/wealth/blob/main/scripts/pfire_transformer.py#L33) |
| VERIF-PFIRE-CANONICO | Docs: PFIRE-CANONICO-SPEC.md | 2026-04-26 | Auditoria 4000+ linhas (11 violations, phase 1-3 refactor) | [agentes/referencia/PFIRE-CANONICO-SPEC.md](https://github.com/diegodemorais/wealth/blob/main/agentes/referencia/PFIRE-CANONICO-SPEC.md) |
| CENTRALIZATION_COMPLETE | Python: data_pipeline_engine.py | 2026-04-26 | 306 linhas (DAG orchestrator, validators, snapshots) | [scripts/data_pipeline_engine.py](https://github.com/diegodemorais/wealth/blob/main/scripts/data_pipeline_engine.py) |
| CENTRALIZATION_COMPLETE | Python: bond_pool_engine.py | 2026-04-26 | 262 linhas (bond pool accumulation, depletion logic) | [scripts/bond_pool_engine.py](https://github.com/diegodemorais/wealth/blob/main/scripts/bond_pool_engine.py) |
| CENTRALIZATION_COMPLETE | Python: guardrail_engine.py | 2026-04-26 | 255 linhas (P(FIRE)-based + drawdown-based guardrails) | [scripts/guardrail_engine.py](https://github.com/diegodemorais/wealth/blob/main/scripts/guardrail_engine.py) |
| CENTRALIZATION_COMPLETE | Python: swr_engine.py | 2026-04-26 | 233 linhas (SWR by percentile, floor logic) | [scripts/swr_engine.py](https://github.com/diegodemorais/wealth/blob/main/scripts/swr_engine.py) |
| CENTRALIZATION_COMPLETE | Python: tax_engine.py | 2026-04-26 | 224 linhas (Lei 14.754/2023, DARF, carryforward) | [scripts/tax_engine.py](https://github.com/diegodemorais/wealth/blob/main/scripts/tax_engine.py) |
| CENTRALIZATION_COMPLETE | Python: snapshot_schemas.py | 2026-04-26 | 218 linhas (snapshot schema validators, metadata) | [scripts/snapshot_schemas.py](https://github.com/diegodemorais/wealth/blob/main/scripts/snapshot_schemas.py) |
| CENTRALIZATION_COMPLETE | Python: snapshot_archive.py | 2026-04-26 | 283 linhas (archive, replay, time travel) | [scripts/snapshot_archive.py](https://github.com/diegodemorais/wealth/blob/main/scripts/snapshot_archive.py) |
| CENTRALIZATION_COMPLETE | Python: validators.py | 2026-04-26 | 269 linhas (invariants, cross-field validation) | [scripts/validators.py](https://github.com/diegodemorais/wealth/blob/main/scripts/validators.py) |
| CENTRALIZATION_COMPLETE | Python: withdrawal_engine.py | 2026-04-26 | 281 linhas (spending strategy, rebalance rules) | [scripts/withdrawal_engine.py](https://github.com/diegodemorais/wealth/blob/main/scripts/withdrawal_engine.py) |
| CENTRALIZATION_COMPLETE | Tests: test_bond_pool_engine.py | 2026-04-26 | 348 linhas (25 testes bond pool logic) | [scripts/tests/test_bond_pool_engine.py](https://github.com/diegodemorais/wealth/blob/main/scripts/tests/test_bond_pool_engine.py) |
| CENTRALIZATION_COMPLETE | Tests: test_guardrail_engine.py | 2026-04-26 | 288 linhas (24 testes guardrails dual-impl) | [scripts/tests/test_guardrail_engine.py](https://github.com/diegodemorais/wealth/blob/main/scripts/tests/test_guardrail_engine.py) |
| CENTRALIZATION_COMPLETE | Tests: test_swr_engine.py | 2026-04-26 | 245 linhas (20 testes SWR percentile, floor) | [scripts/tests/test_swr_engine.py](https://github.com/diegodemorais/wealth/blob/main/scripts/tests/test_swr_engine.py) |
| CENTRALIZATION_COMPLETE | Tests: test_tax_engine.py | 2026-04-26 | 298 linhas (24 testes Lei 14.754, DARF) | [scripts/tests/test_tax_engine.py](https://github.com/diegodemorais/wealth/blob/main/scripts/tests/test_tax_engine.py) |
| CENTRALIZATION_COMPLETE | Tests: test_withdrawal_engine.py | 2026-04-26 | 468 linhas (37 testes spending, rebalance) | [scripts/tests/test_withdrawal_engine.py](https://github.com/diegodemorais/wealth/blob/main/scripts/tests/test_withdrawal_engine.py) |
| CENTRALIZATION_COMPLETE | Tests: test_data_pipeline_prohibitions.py | 2026-04-26 | 199 linhas (grep-based prohibition tests) | [scripts/tests/test_data_pipeline_prohibitions.py](https://github.com/diegodemorais/wealth/blob/main/scripts/tests/test_data_pipeline_prohibitions.py) |
| CENTRALIZATION_COMPLETE | Tests: test_prohibition_advanced.py | 2026-04-26 | 296 linhas (AST-based advanced prohibition tests) | [scripts/tests/test_prohibition_advanced.py](https://github.com/diegodemorais/wealth/blob/main/scripts/tests/test_prohibition_advanced.py) |
| CENTRALIZATION_COMPLETE | Tests: test_prohibition_rules.py | 2026-04-26 | 407 linhas (QA rule-based prohibition tests) | [scripts/tests/test_prohibition_rules.py](https://github.com/diegodemorais/wealth/blob/main/scripts/tests/test_prohibition_rules.py) |
| CENTRALIZATION_COMPLETE | Docs: PIPELINE-DAG.md | 2026-04-26 | 338 linhas (pipeline architecture, DAG orchestration) | [agentes/referencia/PIPELINE-DAG.md](https://github.com/diegodemorais/wealth/blob/main/agentes/referencia/PIPELINE-DAG.md) |
| CENTRALIZATION_COMPLETE | Docs: SNAPSHOT-SCHEMA.md | 2026-04-26 | 312 linhas (snapshot schema spec, metadata, validation) | [agentes/referencia/SNAPSHOT-SCHEMA.md](https://github.com/diegodemorais/wealth/blob/main/agentes/referencia/SNAPSHOT-SCHEMA.md) |
| CENTRALIZATION_COMPLETE | Docs: GUARANTEED_INVARIANTS.md | 2026-04-26 | 369 linhas (invariants, compliance, guarantees) | [agentes/referencia/GUARANTEED_INVARIANTS.md](https://github.com/diegodemorais/wealth/blob/main/agentes/referencia/GUARANTEED_INVARIANTS.md) |
| XX-changelog-validator | Python: validate_changelog_registration.py | 2026-04-27 | 188 linhas (pre-commit hook, detecta files não registrados) | [scripts/validate_changelog_registration.py](https://github.com/diegodemorais/wealth/blob/main/scripts/validate_changelog_registration.py) |
| XX-changelog-validator | Hook: .git/hooks/pre-commit | 2026-04-27 | Integração validator + testes (fail-fast changelog check) | [.git/hooks/pre-commit](https://github.com/diegodemorais/wealth/blob/main/.git/hooks/pre-commit) |
| CENTRALIZATION_COMPLETE | Docs: CENTRALIZATION_ANALYSIS.md | 2026-04-26 | 320 linhas (análise consolidação 74 testes, 5 engines) | [CENTRALIZATION_ANALYSIS.md](https://github.com/diegodemorais/wealth/blob/main/CENTRALIZATION_ANALYSIS.md) |
| CENTRALIZATION_COMPLETE | Docs: CHANGELOG_PHASE2_3A.md | 2026-04-26 | 324 linhas (histórico phase 2-3a, 37 testes phase4) | [CHANGELOG_PHASE2_3A.md](https://github.com/diegodemorais/wealth/blob/main/CHANGELOG_PHASE2_3A.md) |
| CENTRALIZATION_COMPLETE | Docs: PHASE1_PROGRESS.md | 2026-04-26 | 104 linhas (phase 1: 4 consolidations, CI enforcement) | [agentes/issues/PHASE1_PROGRESS.md](https://github.com/diegodemorais/wealth/blob/main/agentes/issues/PHASE1_PROGRESS.md) |
| CENTRALIZATION_COMPLETE | Docs: PHASE2_PROGRESS.md | 2026-04-26 | 168 linhas (phase 2: SWR, guardrails, engines) | [agentes/issues/PHASE2_PROGRESS.md](https://github.com/diegodemorais/wealth/blob/main/agentes/issues/PHASE2_PROGRESS.md) |
| CENTRALIZATION_COMPLETE | Docs: PHASE3_PROGRESS.md | 2026-04-26 | 151 linhas (phase 3: prohibition, validation, snapshot) | [agentes/issues/PHASE3_PROGRESS.md](https://github.com/diegodemorais/wealth/blob/main/agentes/issues/PHASE3_PROGRESS.md) |
| CENTRALIZATION_COMPLETE | Docs: PHASE4_PROGRESS.md | 2026-04-26 | 217 linhas (phase 4: integration, data generation) | [agentes/issues/PHASE4_PROGRESS.md](https://github.com/diegodemorais/wealth/blob/main/agentes/issues/PHASE4_PROGRESS.md) |
| CENTRALIZATION_COMPLETE | Docs: CENTRALIZATION_COMPLETE Issue | 2026-04-27 | Issue completa (74 testes, 5 engines, phase 4.1-4.4 merged) | [agentes/issues/CENTRALIZATION_COMPLETE.md](https://github.com/diegodemorais/wealth/blob/main/agentes/issues/CENTRALIZATION_COMPLETE.md) |
| DEV-twr-pipeline-fixes | Python: portfolio_analytics.py | 2026-04-25 | TWR pipeline, RF MTM, Modified Dietz (12.69% 5a) | [scripts/portfolio_analytics.py](https://github.com/diegodemorais/wealth/blob/main/scripts/portfolio_analytics.py) |
| DEV-ux-prototipo | React: CollapsibleSection.tsx | 2026-04-25 | Auto-open feature, UX/layout spec consistency | [react-app/src/components/dashboard/CollapsibleSection.tsx](https://github.com/diegodemorais/wealth/blob/main/react-app/src/components/dashboard/CollapsibleSection.tsx) |
| DASH-2026-04-25-consistency | React: performance/page.tsx | 2026-04-25 | TER corrigido, alpha drought caveat | [react-app/src/app/performance/page.tsx](https://github.com/diegodemorais/wealth/blob/main/react-app/src/app/performance/page.tsx) |
...
| DASH-2026-04-25-consistency | Scripts: generate_data.py | 2026-04-25 | Renda+ taxa unificada (7.08%) | [scripts/generate_data.py](https://github.com/diegodemorais/wealth/blob/main/scripts/generate_data.py) |
| DEV-decisao-mes-redesign | React: DecisaoDoMes.tsx | 2026-04-25 | 340 linhas (340→557 consolidação, 3 bugs) | [react-app/src/components/dashboard/DecisaoDoMes.tsx](https://github.com/diegodemorais/wealth/blob/main/react-app/src/components/dashboard/DecisaoDoMes.tsx) |
