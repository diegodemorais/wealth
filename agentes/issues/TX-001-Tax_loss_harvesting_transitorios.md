...
## Escopo
- Verificar se algum dos 7 ETFs transitorios tem lotes com prejuizo (preco atual < preco de compra do lote)
- Avaliar regras tributarias brasileiras para TLH em ETFs internacionais (Lei 14.754/2023)
- Existe wash sale rule no Brasil? Prazo de recompra?
- Se houver lotes com prejuizo, calcular beneficio fiscal de realizar a perda e recomprar via ETF UCITS equivalente
- Avaliar se o custo de transacao compensa o beneficio
