...
|---------|---------|----------|------|------|
| IPCA+ Longo | DCA por bandas | >=6,0% + RF longa <15%: DCA ativo (TD 2040 80% + TD 2050 20%) · <6,0%: pausar, redirecionar JPGL · alvo 15% atingido: parar DCA, manter HTM | Executar conforme banda | Mensal |
