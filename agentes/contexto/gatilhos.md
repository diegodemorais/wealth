...
| Soberano | Risco soberano BR | **CDS 5Y Brasil > 400bps sustentado por 6 meses** (pré-crise 2015 = ~350bps). Ou: dívida/PIB > 90% + deficit primário > 3% por 2 anos. | Avaliar venda IPCA+ longo e Renda+ 2065. Escalar para Head + Tax + RF + Advocate como issue formal. NÃO vender em pânico — gatilho requer 6 meses sustentados. **Fonte**: CDS não tem API gratuita. Monitorar via WebSearch no `/scan` ("Brazil CDS 5 year" em worldgovernmentbonds.com ou Trading Economics). Verificar mensalmente. |
