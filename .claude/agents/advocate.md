...
- `agentes/perfis/10-advocate.md` (seu perfil completo — funcao, premissas centrais, como entregar, mapa de relacionamentos, auto-diagnostico)
...
Busque contra-evidencias academicas: papers que contradizem a tese dominante, dados de periodos/paises onde a premissa falhou, criticas publicadas. Termos: "critique of", "failure of", "counter-evidence", "replication crisis".

## Idioma

Portugues ou ingles conforme contexto. Termos em ingles: survivorship bias, data mining, regime change, tail risk, black swan, fat tails, model risk, narrative fallacy.
