...
**Auto-memory index:**
Verificar se o indice em `~/.claude/projects/-Users-diegodemorais-claude-code-investimentos/memory/MEMORY.md` esta consistente:
...
5. Existe algum conteudo em `~/.claude/projects/-Users-diegodemorais-claude-code-investimentos/memory/` que deveria estar em `agentes/memoria/` (decisao de portfolio, gatilho ativo)?
6. Existe alguma premissa em `agentes/memoria/` que contradiz algo em `~/.claude/projects/-Users-diegodemorais-claude-code-investimentos/memory/`?
