...
// ═══════════════════════════════════════════════════════════════
export function buildEarliestFire() {
...
export function _applyFireAxes() {
...
// ═══════════════════════════════════════════════════════════════
export function buildSpendingGuardrails() {
...
// ═══════════════════════════════════════════════════════════════
export function _fmtPeriodo(periodo) {
...
// ═══════════════════════════════════════════════════════════════
export function buildLifeEventsEnhanced() {
 ...
 */
export function _renderStressCards(vals, stData) {
 ...
 */
export function runMC(patrimonioInicial, spendingAnual, anosAcumulo, anosAposentadoria, retReal, vol, nTrials, aporteAnual) {
  let sucessos = 0;
 ...
 */
export function runMCTrajectories(pat0, spendingAnual, anosAcumulo, anosAposentadoria, retReal, vol, nTrials, aporteAnual) {
 ...
 */
export function buildStressFanChart(traj, onsetAge, anosAcumulo, shockPct, preShockP50, idadeAtual) {
 ...
 */
export function onStressShockChange(val) {
