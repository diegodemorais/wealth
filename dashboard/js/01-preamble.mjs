...
/**
 * Initialize FOUC (Flash of Unstyled Content) guard.
 * Prevent flash of unstyled content: hide non-"hoje" tabs immediately.
 * This must run synchronously before DOM render.
 */
