// ── S6: Timeline ──────────────────────────────────────────────
export function buildTimeline(period) {
...
export function _isTornadoAcionavel(label) {
...
export function buildStackedAlloc() {
...
// ── S17: Fee Analysis ─────────────────────────────────────────
export function buildFeeAnalysis() {
...
export function interpolateFireMatrix(gastoAnual, swrTarget) {
...
export function buildCustoBase() {
...
export function buildEventosVida() {
...
export function buildPfireFamilia() {
...
export function buildRetornoHeatmap() {
...
export function buildRollingSharp() {
...
export function buildInformationRatio() {
...
export function buildTLH() { buildIrDiferido(); } // alias para compatibilidade tabFns
export function buildIrDiferido() {
...
export function buildBacktest(period) {
...
export function buildBacktestR7() {
...
// ── S23: Shadow Chart ─────────────────────────────────────────
export function buildShadowChart(period) {
